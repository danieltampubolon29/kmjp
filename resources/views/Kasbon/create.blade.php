...
@section('content')
    <x-bar.navbar>Tambah Kasbon
        <x-slot name="content">
            <div class="container mt-4">
                <x-alert-message></x-alert-message>
                <div class="card shadow">
                    <form class="form-submit" id="resetForm" method="POST" action="{{ route('kasbon.store') }}">
                        @csrf
                        <div class="card-header bg-primary text-white">
                            <h5 class="mb-0">Form Tambah Kasbon</h5>
                        </div>
                        <div class="card-body">
                            <div class="mb-3">
                        ...
                        <div class="card-footer bg-light d-flex justify-content-end">
                            <a href="{{ route('kasbon.index') }}" class="btn btn-secondary me-2">
