<div class="modal fade" id="lockConfirmationModal{{ $kasbon->id }}" tabindex="-1"
       ...
       <div class="modal-content">
           <div class="modal-header">
               <h5 class="modal-title" id="lockConfirmationModalLabel">
                   Konfirmasi {{ $kasbon->is_locked ? 'Buka Kunci' : 'Kunci' }}
               </h5>
           ...
           <div class="modal-footer">
               ...
               <form action="{{ route('kasbon.lock', $kasbon->id) }}" method="POST" style="display:inline;">
                   @csrf
                   <button type="submit" class="btn btn-success">
                       {{ $kasbon->is_locked ? 'Buka Kunci' : 'Kunci' }}
                   </button>
               </form>
           </div>
       </div>
